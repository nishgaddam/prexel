...
class PrettyPrintEncoder(Encoder):
    ...
    |PrettyPrintEncoder generate() create_class() create_aggregation_arrow() create_inheritance_arrow() concat_aggregation()
    |Encoder
    |PrettyPrintEncoder >> Encoder
    ...
    |generate()                |
    |create_class()            |
    |create_aggregation_arrow()|
    |create_inheritance_arrow()|
    |concat_aggregation()      |
    |__________________________|
    ∆
    |_______ 
