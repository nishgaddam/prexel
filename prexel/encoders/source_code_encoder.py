...
|SourceCodeEncoder generate() create_class() process_method_signature() get_user_defined_identation() sourceCodeEncoderException()
|Encoder
|SourceCodeEncoder >> Encoder
...
|generate()                   |
|create_class()               |
|process_method_signature()   |
|get_user_defined_identation()|
